...
const Hotels = () => {
  ...
  const formFields = [
    ...
    { key: 'stars', label: 'Stars (1-5)', type: 'select', options: ['1','2','3','4','5'] },
    { key: 'price', label: 'Price per Night (DZD)', type: 'number' },
    { key: 'image_url', label: 'Image', type: 'image', folder: 'hotels' },
